...
gem 'rmagick',                   '>= 2.12.2', :require_as => 'RMagick2'                             # http://rubyforge.org/projects/rmagick/
gem 'thinking-sphinx-099',       '1.3.2',     :require_as => 'thinking_sphinx'                      # http://github.com/freelancing-god/thinking-sphinx/tree/master
gem 'ts-delayed-delta',          '>= 1.0.0',  :require_as => 'thinking_sphinx/deltas/delayed_delta' # http://github.com/freelancing-god/ts-delayed-delta
gem 'gravtastic',                '>= 2.1.0'                                                         # http://github.com/chrislloyd/gravtastic
gem 'russian',                   '>= 0.2.2'                                                         # http://github.com/yaroslav/russian/tree/master
gem 'Ascii85',                   '>= 0.9.0',  :require_as => 'ascii85'                              # требуется для pdf-reader'а, http://ascii85.rubyforge.org/
gem 'pdf-reader',                '>= 0.7.7',  :require_as => 'pdf/reader'                           # http://github.com/yob/pdf-reader
gem 'rubyzip',                   '>= 0.9.1',  :require_as => 'zip/zipfilesystem'                    # http://rubyzip.sourceforge.net/
